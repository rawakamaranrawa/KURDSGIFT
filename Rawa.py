...
My Telegram-@OFF_RAWA

Telegram chanell:@KURDSGIFT
____________________________________"""
logo2 = """ """
CorrectUsername = 'Rawa'
CorrectPassword ='KURDSGIFT1'
os.system('clear')
print logo2
loop = 'true'
while loop == 'true':
...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;97m Bo Xaty Korak'
    print '\x1b[1;97m[2]\x1b[1;97m  Bo Xaty Asiasell'
    print '\x1b[1;97m[3]\x1b[1;97m  Bo Xaty IQ'
    print '\x1b[1;97m[4]\x1b[1;97m  Bo Xaty Tp Link'
    print '\x1b[1;97m[5]\x1b[1;97m  Bo Zor bay Xatakn \033[92m \033[97m'
    print '\n\x1b[1;97m[0]  Exit            '
    print '\x1b[1;97m--------------------------------------------------\n'
    action()
...
def action():
    ...
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] Crack Dasty Pe Krd')
    time.sleep(0.5)
